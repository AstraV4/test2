  ...
  return (
    <div className="py-8 max-w-lg mx-auto space-y-6">
      <div className="text-center">
        ...
        <p className="text-muted mt-1">Crée un salon ou rejoins-en un avec un code. Choisis ensuite <b className="text-text">Imposteur</b>, <b className="text-text">Draw & Guess</b> ou <b className="text-text">Party</b> dans le salon.</p>
      </div>
